...
<div class="bdy container" style="background-color:#000000ab;">
  ...
  <h3>Our Product's</h3><br>
        <div class="row">
        <?php
        $query=mysqli_query($con,"select * from add_product");
        while($fet=mysqli_fetch_array($query))
        {
        ?>
  
    <div class="col-md-4">
				<form method="post" action="view_product.php?id=<?php echo $fet["id"]; ?>">
...
<img style="height:250px;width:290px;" src="../admin/upload/<?php echo $fet["image"]; ?>" class="img-responsive" /><br />
