...
<div class="container">
            ...
            $id=$_GET['id'];
				...
				if(mysqli_num_rows($result) > 0)
				{
					...
					{
				?>
			<div class="row" style="background-color:#0000008c;">
                <br>
				<div class="col-md-12">
                <img style="width:500px;" src="../admin/upload/<?php echo $row['image']; ?>">
                </div>
                <hr>
			    <div class="col-md-12">
                    <table class="table">
                ...
                <tr><td><b>Enquiry Date</b></td> <td>:</td> <td><form method="post">
                                <input type="date" class="form-control" required name="enqdate">
                    </td></tr>
                           
                            
                        <tr><td><input type="submit" name="sb" value="Book Enquiry" class="btn btn-primary form-control">
                                </form></td></tr>
                        </table>
