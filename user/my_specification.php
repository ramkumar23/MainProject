...
$qq="select * from registration where uname='$uses'";
...
<div class="form-group row">
        <h1 style=""><u>Add Specifications</u></h1>
    </div>
...
<div class="form-group row">
    ...
    <div class="form-group row">
        <label class="col-sm-3 col-form-label"></label>
        <div class="col-sm-9">
        <button type="submit" name="sb" class="btn btn-primary form-control">Post Your Product</button><br><br><br><br>
        </div>
    </div>
</form>
    <div class="footer">
...
if(isset($_POST['sb']))
{
    ...
    $query="INSERT INTO `user_product`(`image`, `name`, `price`, `color`, `description`, `milage`, `fuel_type`, `engile_cc`, `torque`, `seat_capacity`, `transmission_type`, `boot_space`, `fuel_tank_capacity`, `body_type`, `service_cost`, `power_steering`, `power_window`, `ac`, `driver_airbag`, `passenger_airbag`, `alloy_wheel`, `usr_name`, `user_name`, `usr_phone`) VALUES('$filee','$name','$price','$color','$desc','$milage','$fuel_type','$engine_cc','$torque','$seat_capacity','$transmission_type','$boot','$fuel_capacity','$body_type','$service_cost','$power_steering','$power_window','$ac','$driver_airbag','$passenger_airbag','$alloy_wheel','$uses','$nm','$ph')";
